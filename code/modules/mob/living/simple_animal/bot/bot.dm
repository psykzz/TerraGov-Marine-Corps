...
/mob/living/simple_animal/bot/proc/drop_part(obj/item/drop_item, dropzone)
	...
	if(istype(dropped_item, /obj/item/cell))
		var/obj/item/cell/dropped_cell = dropped_item
...
/mob/living/simple_animal/bot/proc/bot_control(command, mob/user, list/user_access = list())
	if(!on || remote_disabled) //Emagged bots do not respect anyone's authority! Bots with their remote controls off cannot get commands.
