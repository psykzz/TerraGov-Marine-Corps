...
/mob/living/simple_animal/bot/medbot/proc/medicate_patient(mob/living/carbon/C)
	...
	while(tending)
		...
		if(!treatment_method) //If they don't need any of that they're probably cured!
...
/mob/living/simple_animal/bot/medbot/proc/declare(crit_patient)
	if(COOLDOWN_CHECK(src, COOLDOWN_SAY))
		return
	COOLDOWN_START(src, COOLDOWN_SAY, declare_cooldown)
...
/obj/machinery/bot_core/medbot
	req_one_access = list(ACCESS_MARINE_MEDBAY, ACCESS_MARINE_LOGISTICS)
